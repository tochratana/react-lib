...
import { toggleMenu } from "../../features/counter/counterSlice.js"; // Adjust path as needed
      ...
      <ul>
        {menuItems.map((item) => (
          <li key={item.id} className="p-2 border-b border-gray-700">
            <button
              onClick={() => dispatch(toggleMenu(item.id))}
            ...
            {activeMenus[item.id] && (
              <ul className="ml-4 mt-2">
                <li className="text-sm">Sub-Item 1</li>
                <li className="text-sm">Sub-Item 2</li>
              </ul>
            )}
          </li>
        ))}
